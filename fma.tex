...
\begin{table*}[t]
	...
	\begin{threeparttable}
		...
		\cmidrule{6-8}
				&           & \multicolumn{3}{c}{}               & \text{scale} & [GiB] & [days] \\
		\midrule
