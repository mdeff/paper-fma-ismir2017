...
\begin{table}
	...
	\begin{tabular}{lrrrrrr}
		...
		\midrule
		Chroma \cite{chroma} & 84 \\
		Tonnetz \cite{tonnetz} & 42 \\
		MFCC \cite{mfcc} & 140 \\
		Spec. centroid & 7 \\
		Spec. bandwidth & 7 \\
		Spec. contrast \cite{contrast} & 49 \\
		Spec. rolloff & 7 \\
	...
	\caption{MGR results for various features and classifiers.}
	% Todo small / medium / large / full
	\label{tab:mgr}
	\label{tab:features}
\end{table}
