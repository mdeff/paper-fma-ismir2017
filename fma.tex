...
\begin{figure*}
	...
	\end{minipage}
	\vspace{-1em}
	\caption{(Left) Growth of the archive, created in 2008. (Right) Number of albums released per year (1902-2017).}
	\label{fig:growth}
...
\begin{figure}
	...
	\caption{Gaussian distribution of track durations.}
...
\begin{figure}
	...
	\caption{Power-law distribution of album play counts.}
...
\begin{figure}
	...
	\end{minipage}
	\vspace{-1em}
	\caption{(Left) Example of genre hierarchy for the top-level Soul-RnB genre. Left number is the \texttt{genre\_id}, right number is the number of tracks per genre. (Right) Number of genres per track (\texttt{genres\_all}).}
...
\begin{figure}[t]
	...
	\caption{Power law distribution of genres.}
